...
# centder - do, our - unimportant to differentiate that everybody uses / quite rare to see the application because it is difficult to validate the result
# discriminative words - 에펠탑 양쪽 끝에 있는 것 
...
```{r}
cong <- read.csv("../week05/data/congress-tweets.csv", stringsAsFactors=F)
...
# running wordfish
# you'll need to gice two document you as human identifier 
# we need this to interpret the result - although wordfish is unsupervised, it still needs little supervision
# does not change the direction of the model, but it's for the interpretation 
